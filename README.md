...
with difficulty.
– LCD contrast control (optional, it replaces the potentiometer).
Save it to eeprom.
...
### **Process explanation.** ([code])  
:soon:

### **Pictures of the setup.**
![schematic_picture]()
| ![pic1](./Homework_5/WhatsApp%20Image%202022-12-07%20at%2023.56.59.jpeg) | ![pic2]() | 
|:-------------:|:-------------:|
| ![pic4]() | ![pic3]() |
